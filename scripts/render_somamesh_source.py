...
ACCEPTED_SOURCE_BACKEND = "accepted_somamesh_shapes_lbs_source"
ACCEPTED_SOURCE_RENDERER = "SomaMesh LBS"
SOMA_DISPLAY_CONVERSION = "(x, y, z)_display = (x, -z, y)_soma"
...
def render_somamesh_source_panel(
    *,
    ...
    source_bvh_sha256 = file_sha256(bvh_path)
    return {
        "status": "ok",
        "stem": title or bvh_path.stem,
        "panel": "SOMA Shapes / SomaMesh",
        "backend": ACCEPTED_SOURCE_BACKEND,
        "render_backend": ACCEPTED_SOURCE_BACKEND,
        "source_renderer": ACCEPTED_SOURCE_RENDERER,
        ...
        "source_display_conversion": SOMA_DISPLAY_CONVERSION,
