...
| Acceleration/jerk | source, G1 | Pending | Second/third finite differences after unit normalization; PHUMA reports root jerk as a formal filtering metric and KDMR flags high acceleration as actuator-infeasible | `quarantine` high jerk; category-aware for jumps/fights |
...
11. Add acceleration/jerk and support-base/pelvis-height scans before promoting a policy beyond the current representative evidence.
