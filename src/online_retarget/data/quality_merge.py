        ...
        candidates.append(
            {
                ...
                "source_max_abs_channel_acceleration": _stat(source, "max_abs_channel_acceleration"),
                "source_max_root_acceleration": _stat(source, "max_root_acceleration"),
                "source_max_root_jerk": _stat(source, "max_root_jerk"),
                ...
                "source_fk_mean_root_height": _stat(source_fk, "mean_root_height"),
                "source_fk_support_frame_ratio": _stat(source_fk, "support_frame_ratio"),
                "source_fk_mean_root_support_distance": _stat(
                    source_fk, "mean_root_support_distance"
                ),
                "source_fk_max_root_support_distance": _stat(
                    source_fk, "max_root_support_distance"
                ),
                ...
                "g1_max_abs_joint_acceleration": _stat(g1, "max_abs_joint_acceleration"),
                "g1_max_root_acceleration": _stat(g1, "max_root_acceleration"),
                "g1_max_root_jerk": _stat(g1, "max_root_jerk"),
                "g1_max_root_speed": _stat(g1, "max_root_speed"),
                "g1_root_height_min": _stat(g1, "root_height_min"),
                "g1_root_height_max": _stat(g1, "root_height_max"),
                "g1_root_height_range": _stat(g1, "root_height_range"),
...
def _worst_sort_key(row: Mapping[str, str]) -> tuple[float, ...]:
    return (
        ...
        _float(row.get("g1_max_root_jerk", "")),
        _float(row.get("source_max_root_jerk", "")),
        _float(row.get("g1_max_root_acceleration", "")),
        _float(row.get("source_max_root_acceleration", "")),
        _float(row.get("g1_max_abs_joint_acceleration", "")),
        _float(row.get("source_max_abs_channel_acceleration", "")),
